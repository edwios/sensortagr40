...
#define MPU_SPI_MISO_PIN    31 // MPU SDO. 'AD0' on MPU breakout board silk screen
#define MPU_SPI_MOSI_PIN    25  // MPU SDI. 'SDA' on MPU breakout board silk screen
#define MPU_SPI_SCL_PIN     26  // MPU SCLK. 'SCL' on MPU breakout board silk screen
#define MPU_SPI_CS_PIN      30 // MPU nCS. 'NCS' on MPU breakout board silk screen
#else // If PCA10028
