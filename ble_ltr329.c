 ...
 *
 */
static uint32_t ble_char_visible_add(ble_envsense_t * p_ltr329)
{
...
static uint32_t ble_char_ir_add(ble_envsense_t * p_ltr329)
{
    uint32_t   err_code = 0; // Variable to hold return codes from library and softdevice functions
...
static uint32_t ble_char_lux_add(ble_envsense_t * p_ltr329)
{
    uint32_t   err_code = 0; // Variable to hold return codes from library and softdevice functions
